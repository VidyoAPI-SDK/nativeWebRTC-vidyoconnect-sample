...
const call = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SET_DISCONNECT_REASON:
      return {
        ...state,
        customDisconnectReason: action.payload,
      };
