...
export const closedCaptionCallEnd = () => ({
  type: "CLOSED_CAPTION_CALL_END",
});
export const breakoutRoomClick = (info) => ({
  type: "BREAKOUT_ROOM_CLICK",
  info,
});
export const breakoutRoom = (info) => ({
  type: "BREAKOUT_ROOM",
  info,
});
export const keyboardShortcuts = (info) => ({
