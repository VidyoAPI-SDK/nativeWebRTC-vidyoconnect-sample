...
class BaseCallAPIProvider {
  ...
  async getJWTToken() {
    return notImplemented("getJWTToken");
  }
  async endCall() {
    return notImplemented("endCall");
  }
  async exitBreakoutRoom() {
    return notImplemented("exitBreakoutRoom");
  }
  ...
  async subscribeToTopic() {
    return notImplemented("subscribeToTopic");
  }
  ...
  async setP2PConnection(options) {
    return notImplemented("setP2PConnection");
  }
  async getStats() {
  ...
  async subscribeOnReconnectStateChange(onChange) {
    return notImplemented("subscribeOnReconnectStateChange");
  }
  ...
  async subscribeOnModerationTopic() {
    return notImplemented("subscribeOnModerationTopic");
  }
  async subscribeOnBreakoutRooms() {
    return notImplemented("subscribeOnBreakoutRooms");
  }
  async subscribeOnBroadcastMessages() {
    return notImplemented("subscribeOnBroadcastMessages");
  }
  async unsubscribeFromBreakoutRooms() {
    return notImplemented("unsubscribeFromBreakoutRooms");
  }
  async unsubscribeFromBroadcastMessages() {
    return notImplemented("unsubscribeFromBroadcastMessages");
  }
  async unsubscribeFromModerationTopic() {
    return notImplemented("unsubscribeFromModerationTopic");
  }
  async unsubscribeFromCompositorViewChanges() {
    return notImplemented("unsubscribeFromCompositorViewChanges");
  }
  async unsubscribeFromCameraPresetsChanges() {
    return notImplemented("unsubscribeFromCameraPresetsChanges");
  }
  async unsubscribeFromCameraControlPanelChanges() {
    return notImplemented("unsubscribeFromCameraControlPanelChanges");
  }
