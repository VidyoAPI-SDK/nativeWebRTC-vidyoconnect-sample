...
const CameraEffectsSelectorComponent = ({
  ...
  return (
    ...
    >
      <div tabIndex="0" className="camera-effects-selector-title">
      ...
      <ul className="camera-effects-selector-list">
        ...
        {wrapErrorTooltip(
          ...
          >
            <li
              aria-label={t("SETTINGS_CLEAR_BG_EFFECT")}
              role="button"
              tabIndex="0"
        ...
        {predefinedEffects.map((effect) => {
          return wrapErrorTooltip(
            ...
            >
              ...
              >
                <img src={effect.preview} alt={effect.label} />
              </li>
            </Tooltip>
          );
        })}
