            ...
            <div className="account-tab-content__actions">
              <ul>
                ...
                <li
                  role="button"
                  tabIndex="0"
                  id="account-tab-content-sign-out-btn"
                  aria-labelledby="account-tab-content__title account-tab-content-sign-out-btn"
        ...
        <div className="account-tab-content__guest-box">
          ...
          {window.appConfig.REACT_APP_SIGN_IN_ENABLED && (
            <div className="account-tab-content__login">
              <button
                id="account-tab-content-sign-in-btn"
                className="bp5-button bp5-fill bp5-intent-success"
                onClick={singInClickHanlder}
                aria-labelledby="account-tab-content__title account-tab-content-sign-in-btn"
                {...test("SIGNIN")}
              >
                {t("SIGNIN")}
              </button>
